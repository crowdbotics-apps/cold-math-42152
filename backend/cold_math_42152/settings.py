"""
Django settings for cold_math_42152 project.
...
ROOT_URLCONF = 'cold_math_42152.urls'
...
WSGI_APPLICATION = 'cold_math_42152.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "cold_math_42152 API",
    "DESCRIPTION": "API documentation for cold_math_42152 App",
    "VERSION": "v1",
}
